...
: TIME-OUT    ( first last -- )   \ Calender or schedule the job days & hours
  time-total 2@                    topout    51 at-cents  \ Total Hrs  Union
  time-total 2@  1.20 d*  1.00 d/  topout    64 at-cents  \ Total Hrs  Apprentice
  time-total 2@  1.00 d*  8.00 d/  topout 1+ 51 at-cents  \ Total Days Union
  time-total 2@  1.00 d*  6.66 d/  topout 1+ 64 at-cents  \ Total Days Apprentice
  ;
